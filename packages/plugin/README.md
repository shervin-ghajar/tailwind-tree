...
- Generates the full list of Tailwind utility classes into `@tailwind-tree/vite-plugin/safelist`, which will be scanned by the Tailwind compiler and picked as a safelist.
